...
=======
    plot_id = paste("DIGITAF_FLANDERS", "PLOT", Loc, Type, sep = ":"),
    event_id = paste("DIGITAF_FLANDERS", "SAMPLE", Loc, Type, Method, Sampletime, sep = ":")
  )
my_data$occurrenceID <- gsub("_BIODIVERSITY_FLEMISH_TREEROWS", "", my_data$occurrenceID)
>>>>>>> 2386cc66cfa6fc13254240f5b98b10cfd51b4195
my_data
```
